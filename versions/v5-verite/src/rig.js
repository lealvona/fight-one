...
const MOVE_POSES = {
  LH: {
    ...
    follow: { shL: [-1.1, 0.3, 0.1], elL: [-0.6, 0, 0], chest: [0.04, -0.05, 0], root: [0, -0.05, 0.1, 0.05, 0, 0] }
  },
  RH: {
    // Rear straight: hips drive first, rear heel pivots, shoulder covers chin.
    chamber: { shR: [-0.2, 0, 0.32], elR: [-2.4, 0, 0], chest: [0.06, 0.7, 0], hipR: [0.18, -0.2, 0.05] },
    extend: { shR: [-1.45, -0.1, 0], elR: [-0.1, 0, 0], chest: [0.05, -0.55, 0], spine: [0.06, -0.25, 0], neck: [0, 0.25, 0.08], hipR: [0.1, 0.35, 0.05], root: [0, -0.06, 0.28, 0.1, -0.12, 0] },
    follow: { shR: [-1.2, -0.3, 0.15], elR: [-0.7, 0, 0], chest: [0.08, -0.7, 0], hipR: [0.08, 0.4, 0.05], root: [0, -0.07, 0.16, 0.1, -0.16, 0] }
  },
  LL: {
    // Low kick chops down and across; support foot turns over.
    chamber: { hipL: [-0.55, 0, -0.05], kneeL: [1.6, 0, 0], root: [0, -0.04, 0, -0.04, 0.08, 0], kneeR: [0.4, 0, 0] },
    extend: { hipL: [-0.5, 0.25, -0.15], kneeL: [0.25, 0, 0], chest: [0.04, 0.3, 0], root: [0, -0.06, 0.16, -0.08, 0.22, 0.04], kneeR: [0.45, 0, 0] },
    follow: { hipL: [-0.3, 0.45, -0.2], kneeL: [0.6, 0, 0], chest: [0.06, 0.45, 0], root: [0, -0.08, 0.08, -0.04, 0.3, 0.05] }
  },
  RL: {
    // Roundhouse: hip rolls over, support pivots, chest counter-rotates.
    chamber: { hipR: [-1.5, 0, 0.08], kneeR: [2.2, 0, 0], chest: [0.04, 0.1, 0], kneeL: [0.15, 0, 0], root: [0, -0.05, 0, -0.06, -0.1, 0] },
    extend: { hipR: [-1.75, -0.3, 0.18], kneeR: [0.15, 0, 0], chest: [0.05, -0.5, 0], neck: [0, 0.2, 0], kneeL: [0.12, 0, 0], root: [0, -0.03, 0.2, -0.14, -0.35, -0.08] },
...
// Discipline-specific execution: same intent slot, different biomechanics.
const POSE_FLAVOR = {
  decha: {
    // Muay Thai round kick: leg stays long, hip turns fully over.
    RL: {
      chamber: { hipR: [-1.2, 0, 0.1], kneeR: [1.2, 0, 0] },
      extend: { hipR: [-1.6, -0.45, 0.3], kneeR: [0.35, 0, 0], root: [0, -0.02, 0.2, -0.12, -0.5, -0.1] },
      follow: { hipR: [-1.0, -0.6, 0.3], kneeR: [0.8, 0, 0], root: [0, -0.05, 0.1, -0.06, -0.7, -0.06] }
    },
    // Teep: knee up the centerline, hips thrust through.
    BR: {
      chamber: { hipL: [-1.5, 0, -0.05], kneeL: [1.9, 0, 0], shL: [-0.8, 0, -0.2], elL: [-1.8, 0, 0], chest: [0.08, 0.3, 0], root: [0, -0.03, 0, -0.08, 0, 0] },
      extend: { hipL: [-1.45, 0, -0.05], kneeL: [0.15, 0, 0], chest: [0.05, 0.2, 0], shL: [-0.7, 0, -0.3], elL: [-1.6, 0, 0], shR: [-0.5, 0, 0.3], elR: [-1.9, 0, 0], root: [0, -0.04, 0.18, -0.16, 0, 0] },
      follow: { hipL: [-0.8, 0, -0.05], kneeL: [1.0, 0, 0], root: [0, -0.06, 0.06, -0.06, 0, 0] }
    }
  },
  marisol: {
    // Meia-lua de compasso: the whole body spins through the kick.
    RL: {
      chamber: { chest: [0.5, 0.6, 0], hipR: [-0.6, 0, 0.2], kneeR: [0.8, 0, 0], shL: [-1.2, 0.4, -0.3], elL: [-0.6, 0, 0], root: [0, -0.16, 0, 0.3, 0.7, 0] },
      extend: { hipR: [-1.7, -0.4, 0.15], kneeR: [0.1, 0, 0], chest: [0.35, -0.5, 0], root: [0, -0.1, 0.12, 0.12, -1.6, -0.1] },
      follow: { hipR: [-0.9, -0.4, 0.15], kneeR: [0.7, 0, 0], chest: [0.2, -0.3, 0], root: [0, -0.12, 0.04, 0.1, -2.6, -0.05] }
    }
  },
  suyin: {
    // Fouetté: high tight chamber, whip from the knee, instant retraction.
    RL: {
      chamber: { hipR: [-1.9, 0, 0.1], kneeR: [2.4, 0, 0], root: [0, -0.04, 0, -0.04, -0.15, 0] },
      extend: { hipR: [-1.9, -0.15, 0.1], kneeR: [0.1, 0, 0], chest: [0.04, -0.35, 0], root: [0, -0.02, 0.16, -0.1, -0.25, -0.04] },
      follow: { hipR: [-1.7, 0, 0.1], kneeR: [2.0, 0, 0], root: [0, -0.04, 0.04, -0.06, -0.15, 0] } // re-chambered
    }
  },
  daichi: {
    // Gyaku-zuki: classic hikite - the off hand pulls back hard to the hip.
    RH: {
      extend: { shL: [0.3, 0, -0.25], elL: [-1.9, 0, 0], shR: [-1.45, -0.1, 0], elR: [-0.1, 0, 0], chest: [0.05, -0.6, 0], root: [0, -0.08, 0.26, 0.06, -0.14, 0] },
      follow: { shL: [0.2, 0, -0.2], elL: [-2.0, 0, 0] }
    }
  },
  bastion: {
    // Keysi hammerfist arcs down through the target.
    RH: {
      chamber: { shR: [-2.4, 0, 0.4], elR: [-1.6, 0, 0], chest: [-0.1, 0.5, 0] },
      extend: { shR: [-1.1, -0.1, 0.1], elR: [-0.4, 0, 0], chest: [0.35, -0.4, 0], neck: [0.25, 0, 0], root: [0, -0.1, 0.24, 0.2, 0, 0] },
...
export function createRig(char, side) {
  ...
  const skinM = mat(c.skin, { rough: 0.55, envInt: 0.34 }); // sweat sheen
  ...
  let walkPhase = 0;
  let currentX = 0;
  let lunge = null; // { time, dur, dist } visual step-in so contact lands on the body
  let introTimer = 0;
  let reaction = null;
  let celebrate = false;
  let defeated = false;
  ...
  function react(type, payload = {}) {
    if (type === "hit") {
      ...
      const dur = 280 + power * 180;
      if (height === "high") reaction = { dur, time: dur, pose: { neck: [-0.65, 0.25, 0], chest: [-0.26, 0.12, 0], rootZ: -0.14 - power * 0.1 } };
      else if (height === "low") reaction = { dur, time: dur, pose: { rootY: -0.12, chest: [0.24, 0, 0.12], rootZ: -0.07 - power * 0.05 } };
      else reaction = { dur, time: dur, pose: { chest: [0.5, 0.18, 0], neck: [0.36, 0, 0], rootZ: -0.12 - power * 0.09, rootY: -0.05 } };
    } else if (type === "lunge") {
      lunge = { dur: 420, time: 420, dist: Math.min(0.7, Math.max(0, payload.dist || 0)) };
    } else if (type === "block") {
  ...
  function update(dt, ctx) {
    ...
    if (lunge) {
      ...
      if (lunge.time <= 0) lunge = null;
        ...
        // Fast in, eased back out - the strike carries the body to the target.
    ...
    if (actor.koed || (actor.downTime > 0 && actor.downTime > 380)) {
      ...
      if (char.id === "marisol") {
        // The ginga never stops: constant triangular weight transfer.
        const g = t * 0.0035;
